...
class Delight(object):
    ...
    def get_PS1_r(self, ra, dec):
        ...
        result = tesis_opt.fits_cutout(ra,dec,11,480)
        ...
        print(f"Downloaded {filename} using Diego's API.")
    ...
    def load_model(self, modelversion='v1', modelfile=None):
        ...
        self.tfmodel = keras.models.load_model(self.modelfile)
